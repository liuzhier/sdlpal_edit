...
INT CPalApp::is_Use_YJ1_Decompress()
{
	//测试是否应用YJ1解压
...
INT CPalApp::PAL_DeCompress(LPCVOID Source, LPVOID Destination, INT DestSize)
{
...
////
int  CPalApp::EncodeYJ1(const void* Source, UINT32 SourceLength, void*& Destination, UINT32& Length)
{
	YJ_1_FILEHEADER hdr;
	PYJ_1_BLOCKHEADER header;
...
int CPalApp::EncodeYJ2(const void* Source, UINT32 SourceLength, void*& Destination, UINT32& Length, bool bCompatible)
{
...
int CPalApp::EnCompress(const void* Source, UINT32 SourceLength, void*& Destination, UINT32& Length, bool bCopatible)
{
	if (is_Use_YJ1_Decompress())
